...
//                             <p class="dropdown-info__title">Source to Pay</p> 
//                             <p class="dropdown-info__description">Improve goods/services business</p> 
//                         </div>
//                     </a>
//                 </li>
//                 <li>
...
//                         <div class="dropdown-info">
//                             <p class="dropdown-info__title">eInvoicing</p> 
//                             <p class="dropdown-info__description">Support suppliers and buyers </p> 
//                         </div>
//                     </a>
//                 </li>
//                 <li>
...
//                         <div class="dropdown-info">
//                             <p class="dropdown-info__title">B2B eCommerce </p> 
//                             <p class="dropdown-info__description">Automating buyer and supplier trade </p> 
//                         </div>
//                     </a>
//                 </li>
//             </ul>
...
//                         <div class="dropdown-info">
//                             <p class="dropdown-info__title">News</p> 
//                             <p class="dropdown-info__description">Expolore news related to valtatech</p> 
//                         </div>
//                     </a>
//                 </li>
//                 <li>
...
//                         <div class="dropdown-info">
//                             <p class="dropdown-info__title">Case Studies</p> 
//                             <p class="dropdown-info__description">Explore our interesting case study</p> 
//                         </div>
//                     </a>
//                 </li>
//                 <li>
...
//                         </svg>
//                         <div class="dropdown-info">
//                             <p class="dropdown-info__title">Thought Leadership</p> 
//                             <p class="dropdown-info__description">Explore about thought leadership</p> 
//                         </div>
