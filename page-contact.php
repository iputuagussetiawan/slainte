                    ...
                    <div class="contact-form__form-container">
                        ...
                        switch ($currentLanguage) {
                            case "en":
                                ...
                                break;
                            case "id":
                                echo do_shortcode('[contact-form-7 id="235" title="Contact ID"]');
                                break;
                            case "fr":
                                echo do_shortcode('[contact-form-7 id="238" title="Contact FR"]');
                                break;
                            case "zh":
                                echo do_shortcode('[contact-form-7 id="244" title="Contact ZH"]');
                                break;
                            default:
