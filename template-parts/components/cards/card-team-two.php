...
?>
<div class="card-team-two">
    <div class="card-team-two__image-container">
        <img src="<?= $cardteamImage; ?>" alt="" class="card-team-two__image">
    </div>
    <div class="card-team-two__info-container">
        <h4 class="card-team-two__title">
            <?= $cardteamTitle; ?>
        </h4>
        <p class="card-team-two__position"><?= $cardteamPosition; ?></p>
        <p class="card-team-two__description"><?= $cardteamDescription; ?>
        </p>

        <!-- <ul class="card-team-two__social-icon">
            <?php 
                if($cardteamFB):
            ?>
            <li class="card-team-two__social-item">
                <a href="<?= $cardteamFB; ?>" class="card-team-two__social-link">
                    <svg class="card-team-two__social-icon" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            ?>
            <li class="card-team-two__social-item">
                <a href="<?= $cardteamTwitter; ?>" class="card-team-two__social-link">
                    <svg class="card-team-two__social-icon" width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            ?>
            <li class="card-team-two__social-item">
                <a href="<?= $cardteamLinkedIn; ?>" class="card-team-two__social-link">
                    <svg class="card-team-two__social-icon" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
